...
var pt = document.querySelector("#inputPT");
var inPT = document.querySelector("#inputInches");

pt.addEventListener('input', function(){
  let input = parseFloat(document.getElementById("inputPT").value);
  let answer = document.getElementById("inputInches");
  answer.value = input / 72;
})

inPT.addEventListener('input', function(){
let input = parseFloat(document.getElementById("inputInches").value);
let answer = document.getElementById("inputPT");
answer.value = input * 72;
})
